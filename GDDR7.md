...
|PPR|Yes|No|
|ODT| Yes|Yes|
|VREF DQ| No dedicated Pin, MRS Controlled %VDDQ|No dedicated Pin, MRS Controlled %VDDQ| External VDDQL pin, MRS Controlled %VDDQL |
|VREF CA| No dedicated Pin, MRS Controlled %VDDQ| External VREFC pin| External VDDQL pin, MRS Controlled %VDDQL |
|VDD|1.2V|1.2V or 1.35V| 1.1V |
|VDDQ|1.2V|1.2V or 1.35V| 1.1V |
|VPP <br> (power for row select bus)|1.8V|1.8V| 1.8V|
|WCK| for CA and DQ| only for DQ|
|CK | DRAN internal generated by div | external input |
|CK : WCK | 1:4 | 1:4| 1:2 |
|Command| Row and Column Command semi-independent <br> row and column command could be issued at the same time| dependent | independent |
| Data Scramble | Yes | No| No |
